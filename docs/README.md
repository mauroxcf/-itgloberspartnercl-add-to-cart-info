# Resumen rápido añadir al carrito

## Preview

![image](https://user-images.githubusercontent.com/66022141/209568203-5381838b-60d3-42dc-af3f-07862ab04504.png)
...
```
git clone https://github.com/mauroxcf/itgloberspartnercl-add-to-cart-info.git
```
...
1. "vtex.native-types"
2. "vtex.checkout-resources"
3. "vtex.order-manager"
4. "vtex.product-context"
